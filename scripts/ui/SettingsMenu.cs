...
/// kéo slider/chọn option (preview tức thì qua SettingsManager). Nút Back đóng menu này và
/// gọi MenuScreen.ShowPrevious() để quay lại đúng context cũ (MainMenu / Pause / Surface).
/// </summary>
